...
from .views import RegisterView, LoginView, ProfileView,UsersCamera, AddCameraView,stream,ObjectDetectionView,UpdateUserProfileView,upload_profile_image,get_profile_image
